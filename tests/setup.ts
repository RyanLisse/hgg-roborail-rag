...
process.env.NEON_DATABASE_URL = process.env.NEON_DATABASE_URL || process.env.POSTGRES_URL || 'postgresql://test:test@localhost:5432/test';
process.env.BLOB_READ_WRITE_TOKEN = process.env.BLOB_READ_WRITE_TOKEN || 'test-blob-token';
process.env.REDIS_URL = process.env.REDIS_URL || 'redis://localhost:6379';
process.env.LANGCHAIN_API_KEY = process.env.LANGCHAIN_API_KEY || 'test-langchain-key';
