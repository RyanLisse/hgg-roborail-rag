...
${
  hasContext
    ? `You have access to relevant context from the knowledge base. Use this context to provide accurate, well-sourced answers.
...
- Maintain accuracy over completeness`
    : `You should provide helpful answers based on your training knowledge.
