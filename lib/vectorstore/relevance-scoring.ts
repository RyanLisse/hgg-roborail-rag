...
export type { ScoringWeights as RelevanceWeights }; // Alias for backward compatibility
...
export class RelevanceScoringEngine {
  ...
  private readonly userFeedbackCache: Map<string, number> = new Map();
  private readonly keywordCache: Map<string, string[]> = new Map();
  ...
  async scoreAndRankDocuments(
    ...
    try {
      ...
      if (this.config.debugMode) {
        // Debug information would be logged here
      }
