...
describe('Entitlements', () => {
  describe('entitlementsByUserType', () => {
    ...
    it('should have entitlements for regular users', () => {
      ...
      expect(regularEntitlements.availableChatModelIds.length).toBeGreaterThan(0);
    });
    ...
    it('should give regular users more model options than guests', () => {
      ...
      const regularModels = entitlementsByUserType.regular.availableChatModelIds;
    ...
    it('should include default models for both user types', () => {
      ...
      // Core models that should be available to both
      const coreModels = [
        'openai-gpt-4.1',
    ...
    it('should have reasonable message limits', () => {
      ...
      expect(regularLimit).toBeLessThan(10000);
    });

    it('should maintain provider diversity', () => {
      const regularModels = entitlementsByUserType.regular.availableChatModelIds;
      const providers = new Set(regularModels.map(model => model.split('-')[0]));
